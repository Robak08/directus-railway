...
module.exports = function (env) {
	return {
		...
		APP_INVITE_URL: env.APP_INVITE_URL,
		APP_ORIGIN: env.APP_ORIGIN,
		KRK_GUIDE_PROVISION_USERS: env.KRK_GUIDE_PROVISION_USERS,
		...
		PUSH_PUBLIC_VAPID_KEY: env.PUSH_PUBLIC_VAPID_KEY || env.VAPID_PUBLIC_KEY,
		PUSH_PRIVATE_VAPID_KEY: env.PUSH_PRIVATE_VAPID_KEY || env.VAPID_PRIVATE_KEY,
		PUSH_VAPID_SUBJECT: env.PUSH_VAPID_SUBJECT,
		STRIPE_SECRET_KEY: env.STRIPE_SECRET_KEY,
		STRIPE_VERIFICATION_SECRET: env.STRIPE_VERIFICATION_SECRET,
		STRIPE_GUIDEBOOK_PRICE_ID: env.STRIPE_GUIDEBOOK_PRICE_ID,
	};
};
