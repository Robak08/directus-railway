...
export const directusState: DirectusState = {
	collections: [
		{
			collection: 'tours',
			meta: {
				...
				translations: [
					{
						...
						singular: 'Tour Translation',
						plural: 'Tour Translations'
					},
					{
						language: 'fi-FI',
						translation: 'Kierroksen käännökset',
						singular: 'Käännös',
						plural: 'Käännökset'
					}
				],
		...
		},
		{
			...
			meta: {
				...
				translations: [
					{
						language: 'en-US',
						translation: 'Tour Steps',
						singular: 'Tour Step',
						plural: 'Tour Steps'
					},
					{
						language: 'fi-FI',
						translation: 'Kierroksen pysähdykset',
						singular: 'Pysähdys',
						plural: 'Pysähdykset'
					}
				],
				...
				translations: [
					{
						...
						singular: 'Step Translation',
						plural: 'Step Translations'
					},
					{
						language: 'fi-FI',
						translation: 'Pysähdyksen käännökset',
						singular: 'Käännös',
						plural: 'Käännökset'
					}
				],
		...
		},
		{
			...
			meta: {
				...
				translations: [
					{
						language: 'en-US',
						translation: 'Tour Regions',
						singular: 'Tour Region',
						plural: 'Tour Regions'
					},
					{
						language: 'fi-FI',
						translation: 'Kierroksen alueet',
						singular: 'Alue',
						plural: 'Alueet'
					}
				],
	...
	fields: [
		...
		},
		{
			...
			meta: {
				...
				interface: 'list-m2m',
				options: {
					template: '{{places_regions_id.title}}'
				},
				sort: 3,
				width: 'full',
				note: 'At least one region required when access gating is enabled'
			}
		},
		{
			collection: 'tours',
			...
			meta: {
				...
				sort: 4,
				width: 'half',
				note: 'Editorial total duration (minutes), not auto-summed from steps'
			}
		},
		{
			collection: 'tours',
		...
		},
		{
			...
			field: 'id',
			type: 'integer',
			schema: { ...integerPk, table: 'tours_translations' },
			meta: {
				collection: 'tours_translations',
				field: 'id',
				interface: 'input',
		...
		},
		{
			...
			field: 'id',
			type: 'integer',
			schema: { ...integerPk, table: 'tour_steps' },
			meta: {
				collection: 'tour_steps',
				field: 'id',
				interface: 'input',
		...
		},
		{
			...
			field: 'id',
			type: 'integer',
			schema: { ...integerPk, table: 'tour_steps_translations' },
			meta: {
				collection: 'tour_steps_translations',
				field: 'id',
				interface: 'input',
		...
		},
		{
			...
			schema: {
				name: 'tour_steps_id',
				table: 'tour_steps_translations',
				data_type: 'integer',
				is_nullable: false,
				is_primary_key: false,
				has_auto_increment: false,
				foreign_key_column: 'id',
				foreign_key_table: 'tour_steps'
			},
			meta: {
				collection: 'tour_steps_translations',
				field: 'tour_steps_id',
		...
		},
		{
			...
			field: 'id',
			type: 'integer',
			schema: { ...integerPk, table: 'tours_places_regions' },
			meta: {
				collection: 'tours_places_regions',
				field: 'id',
				interface: 'input',
	...
	relations: [
		...
		},
		{
			collection: 'tour_steps_translations',
			field: 'tour_steps_id',
			related_collection: 'tour_steps',
			schema: {
				table: 'tour_steps_translations',
				column: 'tour_steps_id',
				foreign_key_table: 'tour_steps',
				foreign_key_column: 'id',
				on_update: 'NO ACTION',
				on_delete: 'CASCADE'
			...
			meta: {
				many_collection: 'tour_steps_translations',
				many_field: 'tour_steps_id',
				one_collection: 'tour_steps',
				one_field: 'translations',
				junction_field: 'languages_code'
			}
		},
		...
		},
		{
			...
			meta: {
				many_collection: 'tours_places_regions',
				many_field: 'tours_id',
				one_collection: 'tours',
				one_field: 'regions',
				junction_field: 'places_regions_id'
			}
		},
		{
			collection: 'tours_places_regions',
			...
			meta: {
				many_collection: 'tours_places_regions',
				many_field: 'places_regions_id',
				one_collection: 'places_regions',
				one_field: null,
				junction_field: 'tours_id'
			}
		}
